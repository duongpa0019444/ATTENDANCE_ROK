...
const adminSteps = [
  ...
  },
  {
    ...
    items: [
      ...
      'Sang tab Quản lý Ca làm để tạo khung giờ cho một hoặc nhiều server cùng lúc.',
      'Mỗi khung giờ gồm server, tên mô tả tùy chọn và giờ bắt đầu ca.',
      'Xóa server hoặc ca làm sẽ ảnh hưởng đến lịch phân ca liên quan, cần kiểm tra trước khi xóa.',
    ],
  },
  {
    icon: Calendar,
    title: '3. Phân ca theo tuần',
    items: [
      'Trong tab Quản lý Phân ca, chọn Tuần phân ca bằng bộ chọn ngày.',
      'Bảng matrix hiện server/ca theo hàng và các ngày Thứ 2 đến Chủ nhật theo cột.',
      'Click vào ô giao giữa ca và ngày để chọn một hoặc nhiều nhân viên trực ca.',
      'Có thể lọc theo server, lọc theo nhân viên, phóng toàn màn hình và xem thống kê số ca trong tuần.',
    ],
  },
  {
    icon: DollarSign,
    ...
    items: [
      ...
      'Tab Cấu Hình Thù Lao dùng để đặt lương ca mặc định, phụ cấp đêm 22h-3h, phụ cấp sau 3h-7h và phụ cấp cuối tuần.',
      'Lương ca có thể cấu hình riêng theo server; nếu server không có mức riêng, hệ thống dùng lương ca mặc định.',
    ],
  },
];
